...
API docs are generated by [doc-gen4](https://jonaprieto.github.io/lean-grip/).

The core demo combines positioned parse errors, the type-level progress gate, and the JSON
round-trip contract:
...
[`grip-diagnostics`](https://github.com/jonaprieto/lean-grip-diagnostics) frontend for richer source
...
have gaps: [#44](https://github.com/jonaprieto/lean-grip/issues/44)), nothing about
...
[[require]]
name = "grip"
git = "https://github.com/jonaprieto/lean-grip"
rev = "main"
```
